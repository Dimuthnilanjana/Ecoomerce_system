...
$cursor = $manager->executeQuery('test.customers', $query); // Assuming 'NIBM' is the database and 'customers' is the collection
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $manager->executeBulkWrite('test.customers', $bulkWrite);
